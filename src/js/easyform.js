    ...
    _easyinput.prototype = {
        ...
        judge: {
            ...
            //增添判断项
             "qq": function (ei, v, p)
            {
                if (false == /^[1-9][0-9]{4,}$/.test(v))
                    return ei._error("qq");
                else
                    return ei._success_rule("qq");
            },
            
            
             "msnnum": function (ei, v, p)
            {
                if (false == /^[1-9][0-9]{4,}$/.test(v)) 
                    return ei._error("msnnum");
                else
                    return ei._success_rule("msnnum");
            },
               ...
               "tell": function (ei, v, p)
            {
               ...
               "phi": function (ei, v, p)
            {
                if (false ==/^(\+\d{2,3})?\d{11}$/.test(v)) 
                    return ei._error("phi");
                else
                    return ei._success_rule("phi");
            },
